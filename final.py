...
def dataclean(text):
    ...
    print(score)
    datasetprof.append((words[0],tempemail,tempnum[0],text,words,textpostnlp,score))
...
textextr(files)
print(datasetprof)
datasetprofdf = pd.DataFrame(datasetprof,columns=['Name','Email','Phone Number','Text','Entities','Job Corpus','Similarity Score'])
